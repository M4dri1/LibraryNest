...
const AuthorDetail = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)(Layout_1.default, { title: `Author: ${author.name_author}`, children: [error && (0, jsx_runtime_1.jsx)("div", { className: "error-message", children: error }), (0, jsx_runtime_1.jsxs)("section", { className: "profile-section", children: [(0, jsx_runtime_1.jsx)("button", { onClick: () => navigate('/authors'), className: "back-button", children: "\u2190 Back to Authors" }), (0, jsx_runtime_1.jsx)("h2", { children: author.name_author }), (0, jsx_runtime_1.jsxs)("div", { className: "author-info", children: [author.photo && ((0, jsx_runtime_1.jsx)("img", { src: `/api/uploads/${author.photo}`, alt: author.name_author, className: "author-image" })), (0, jsx_runtime_1.jsxs)("div", { className: "biography-section", children: [(0, jsx_runtime_1.jsx)("h3", { children: "Biography" }), editingBio ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("textarea", { value: biography, onChange: (e) => setBiography(e.target.value), placeholder: "Enter author biography...", rows: 6, className: "biography-textarea" }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("button", { onClick: handleUpdateBiography, disabled: uploading, children: uploading ? 'Saving...' : 'Save Biography' }), (0, jsx_runtime_1.jsx)("button", { onClick: () => {
                                                            setEditingBio(false);
