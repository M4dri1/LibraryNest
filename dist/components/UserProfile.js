...
const UserProfile = () => {
    ...
    const handleReturnBook = async (loanId) => {
        try {
            const response = await axios_1.default.post(`/api/return/${loanId}`, {}, {
                withCredentials: true,
                headers: {
    ...
    return ((0, jsx_runtime_1.jsxs)(Layout_1.default, { title: "User Profile", children: [error && (0, jsx_runtime_1.jsx)("div", { className: "error-message", children: error }), (0, jsx_runtime_1.jsxs)("div", { className: "tabs", children: [(0, jsx_runtime_1.jsx)("button", { className: `tab ${activeTab === 'profile' ? 'active' : ''}`, onClick: () => setActiveTab('profile'), children: "Profile" }), (0, jsx_runtime_1.jsx)("button", { className: `tab ${activeTab === 'loans' ? 'active' : ''}`, onClick: () => setActiveTab('loans'), children: "My Loans" }), (0, jsx_runtime_1.jsx)("button", { className: `tab ${activeTab === 'favorite' ? 'active' : ''}`, onClick: () => setActiveTab('favorite'), children: "Favorite Book" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "tab-content", children: [activeTab === 'profile' && ((0, jsx_runtime_1.jsxs)("section", { className: "profile-section", children: [(0, jsx_runtime_1.jsx)("h2", { children: "Profile Information" }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Username:" }), " ", user?.username || 'Unknown'] }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Role:" }), " ", user?.role || 'User'] }), profile?.profile_image && ((0, jsx_runtime_1.jsx)("img", { src: `/api/uploads/${profile.profile_image}`, alt: "Profile", className: "profile-image" })), (0, jsx_runtime_1.jsxs)("div", { className: "description-section", children: [(0, jsx_runtime_1.jsx)("h3", { children: "Description" }), editingDescription ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("textarea", { value: description, onChange: (e) => setDescription(e.target.value), placeholder: "Tell us about yourself...", rows: 4, className: "description-textarea" }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("button", { onClick: handleUpdateDescription, disabled: uploading, children: uploading ? 'Saving...' : 'Save Description' }), (0, jsx_runtime_1.jsx)("button", { onClick: () => {
                                                            setEditingDescription(false);
                                                            setDescription(profile?.description || '');
                                                        }, className: "cancel-button", children: "Cancel" })] })] })) : ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("p", { children: profile?.description || 'No description added yet.' }), (0, jsx_runtime_1.jsx)("button", { onClick: () => setEditingDescription(true), children: "Edit Description" })] }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "image-upload", children: [(0, jsx_runtime_1.jsx)("h3", { children: "Update Profile Image" }), (0, jsx_runtime_1.jsxs)("form", { onSubmit: handleImageUpload, children: [(0, jsx_runtime_1.jsx)("input", { type: "file", accept: "image/*", onChange: (e) => setImageFile(e.target.files?.[0] || null) }), (0, jsx_runtime_1.jsx)("button", { type: "submit", disabled: !imageFile || uploading, children: uploading ? 'Uploading...' : 'Upload Image' })] })] })] })), activeTab === 'loans' && ((0, jsx_runtime_1.jsxs)("section", { className: "profile-section", children: [(0, jsx_runtime_1.jsx)("h2", { children: "My Borrowed Books" }), loans.length === 0 ? ((0, jsx_runtime_1.jsx)("p", { children: "You haven't borrowed any books yet." })) : ((0, jsx_runtime_1.jsx)("div", { children: loans.map(loan => ((0, jsx_runtime_1.jsxs)("div", { className: "loan-card", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h4", { children: loan.title }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Loan Date:" }), " ", new Date(loan.loan_date).toLocaleDateString()] }), loan.description && (0, jsx_runtime_1.jsx)("p", { children: loan.description })] }), (0, jsx_runtime_1.jsxs)("div", { children: [loan.photo && ((0, jsx_runtime_1.jsx)("img", { src: `/api/uploads/${loan.photo}`, alt: loan.title, className: "loan-book-image" })), (0, jsx_runtime_1.jsx)("button", { onClick: (e) => {
                                                        e.preventDefault();
                                                        handleReturnBook(loan.loans_id);
                                                    }, className: "return-button", children: "Return Book" })] })] }, loan.loans_id))) }))] })), activeTab === 'favorite' && ((0, jsx_runtime_1.jsxs)("section", { className: "profile-section", children: [(0, jsx_runtime_1.jsx)("h2", { children: "My Favorite Book" }), !favoriteBook ? ((0, jsx_runtime_1.jsx)("p", { children: "You haven't set a favorite book yet." })) : ((0, jsx_runtime_1.jsxs)("div", { className: "favorite-book-card", children: [favoriteBook.photo && ((0, jsx_runtime_1.jsx)("img", { src: `/api/uploads/${favoriteBook.photo}`, alt: favoriteBook.title, className: "favorite-book-image" })), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { children: favoriteBook.title }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Author:" }), " ", favoriteBook.author_name || 'Unknown'] }), favoriteBook.description && ((0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Description:" }), " ", favoriteBook.description] }))] })] }))] }))] })] }));
};
